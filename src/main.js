...
//   3. Stale browser cache running an older AppShell.js against the new data
//      layout. The fetch for /db.json (removed in the data-split refactor)
//      404s, mountApp rejects, we catch — but only if the cached main.js
//      itself isn't stale.
//
